...
function renderInterview() {
  ...
  ${iq('Intermediate','What is a reverse proxy, and why use one?',`<p>A server that sits in front of your app servers and forwards client requests to them. It handles HTTPS encryption in one place (TLS termination), plus load balancing, caching, compression and routing &mdash; and hides the backend servers from clients. nginx is a common choice.</p>`)}
