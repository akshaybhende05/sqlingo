...
export default function DevFundamentalsCourse() {
  useEffect(() => {
    ...
    if (window.__ccEngine && window.__ccEngine !== "devfund") { window.location.reload(); return; }
    window.__ccEngine = "devfund";
    if (window.__devfundBooted) {
      ...
      window.__devfundReinit && window.__devfundReinit();
      return;
    }
    window.__devfundBooted = true;
      ...
      <div className="course-shell">
        <aside className="sidebar" id="sidebar">
          <div className="brand">
            ...
            <h1>Dev <span>Fundamentals</span></h1>
            <p>What software, the internet, and servers actually are, before Python, Django, FastAPI, and DevOps.</p>
