...
export default function DjangoCourse() {
  useEffect(() => {
    ...
    if (window.__ccEngine && window.__ccEngine !== "django") { window.location.reload(); return; }
    window.__ccEngine = "django";
    if (window.__djangoBooted) {
      ...
      window.__djangoReinit && window.__djangoReinit();
      return;
    }
    window.__djangoBooted = true;
      ...
      <div className="course-shell">
        <aside className="sidebar" id="sidebar">
          <div className="brand">
            ...
            <h1>Dev <span>Django</span></h1>
            <p>Build a full TastyGo web application: models, views, templates, admin, and auth.</p>
