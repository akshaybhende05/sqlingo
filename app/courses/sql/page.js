...
export default function SqlCourse() {
  useEffect(() => {
    ...
    if (window.__ccEngine && window.__ccEngine !== "sql") { window.location.reload(); return; }
    window.__ccEngine = "sql";
    if (window.__sqlingoBooted) {
      ...
      window.__sqlingoReinit && window.__sqlingoReinit();
      return;
    }
